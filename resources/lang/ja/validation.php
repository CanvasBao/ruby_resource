...
return [
    ...
    'email_ex'             => ':attributeに正しい形式を指定してください。',
    'kana_ex'              => ':attributeはカタカナで指定してください。',
    'password_ex'          => ':attributeは半角英数字記号で指定してください。',
    'code_ex'              => ':attributeには、英数字(\'A-Z\',\'a-z\',\'0-9\')とハイフンと下線(\'-\')が使用できます。',
    'custom'               => [
        'terms' => [
    ...
    'attributes' => [
        ...
        'unit_price' => '販売立米単価',
        'step_img' => 'カットサイズの画像',
        'description_img' => '説明の画像',
        'thickness' => '厚さ',
        'depth' => '奥行',
        'length' => '長さ',
        'content' => '内容',
        'address_1' => '都道府県・市区町村・番地',
        'address_2' => '建物名・号室',
